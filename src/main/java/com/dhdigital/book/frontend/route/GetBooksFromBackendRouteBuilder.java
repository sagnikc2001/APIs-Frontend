...
//		 .log("Entered here")
		 ...
		 .to("http://localhost:8080/api/books/get?bridgeEndpoint=true")  //Bridgepoint to connect to this URL succesfully
		 .unmarshal(new JacksonDataFormat(BooksBackend.class)) //Unmarshalling to Backend object
		 .to("bean:getBooksFromBackendService?method=getBooksResponse");
